...
int main(int argc, char *argv[])
{
    ...
    for (k = dim; k > 0; k--) {
        ...
        if (nbr_k > my_id) {
            ...
            printf("pivot %d, receive number %d\n", pivot, nbr_list_size);
            ...
            // MPI-7: Send number of elements greather than pivot
    ...
    check_list_descending(list, list_size, my_id, num_procs); 
